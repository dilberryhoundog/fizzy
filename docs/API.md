...
|--------------------|---------------------------------------------------|
| `board_ids[]`      | Filter by board ID(s)                             |
| `event_action`     | Filter by event action type                       |
| `event_actions[]`  | Filter by multiple action types                   |
...
curl -H "Authorization: Bearer $TOKEN" \
  -H "Accept: application/json" \
  "https://app.fizzy.do/123456/events?event_action=card_triaged&card_ids[]=abc123"
```
