...
│   │   ├── README.md
│   │   └── WORKSPACE.md
│   └── 251215_[fix]_accounts-menu-name-update
│       ├── context
│       │   ├── .keep
│       │   └── tree.md
│       ├── filebox
...
└── workspace
    ...
    │   │           └── closeable_test.rb
    │   ├── api_quickstart.md
    │   ├── api_quirks_and_notes.md
    │   ├── bug_report_not_now_closure.md
    │   └── README.txt
    ├── history
    │   ├── .keep
    │   ├── 25-12-21_fizzy-api-exploration-testing.txt
    │   └── 25-12-23_not-now-closure-filter-bug-fix.txt
    ├── plans
    │   ├── .keep
    │   ├── architectural.md
    │   └── prd.md
