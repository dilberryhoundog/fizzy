# Proposed addition to app/models/user/accessor.rb
# Add this line after the existing has_many declarations:
...
module User::Accessor
  ...
  included do
    ...
    has_many :accessible_events, through: :boards, source: :events  # <-- ADD THIS LINE
